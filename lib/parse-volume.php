...
function parse_volume($text)
{
	...
	$volume_number_pattern = '(?<volume1>\d+)(\s*-\s*(?<volume2>\d+))?';	
	...
	// flagging a new series
	$new_series_pattern = 'n\.\s*s\.';

	// issue
	$issue_pattern = '(n|No|no|pt|Heft|fasc)\.?\s*((?<issue>\d+)|(?<issue1>\d+)-(?<issue2>\d+))';		
	...
	$patterns = array(
		...
		// n.s. no.12 (1983)
		'/^' . $new_series_pattern . '\s+no\.' . $volume_one_number . $date_pattern_one_year . '/',
		
		// no.125 (2018)
		'/^no\.\s*' . $volume_one_number . $date_pattern_one_year . '/',
		
		// 28, 1976
		'/^' . $volume_number_pattern . ',\s+' .  $year_pattern . '/',
		
		// 5, n. 14, 1941
		// 7, n. 16 , 1943
		'/^' . $volume_one_number . ',\s+' . $issue_pattern . '\s*,\s+' .  $year_pattern . '/',
		
		// ser.4:v.42 (1979-1982)
		// ser.4:v.51 (1999)
		
		//'ser.4:v.1=no.1-7 (1907-1912)',
		//'ser.4:v.2:pt.1=no.8-11 (1913-1917)',
		//'ser.4:v.12:no.1-28 (1923-1924)',	
		//'ser.4:v.54:no.22-27;Index v.54 (2003)',		
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . $date_pattern_two_years . '/',
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . $date_pattern_one_year . '/',

		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . '=no.\d+-\d+' . $date_pattern_two_years . '/',
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . ':' . $issue_pattern . '=no.\d+-\d+' . $date_pattern_two_years . '/',

		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . ':' . $issue_pattern . $date_pattern_two_years . '/',
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern . ':' . $issue_pattern . ';Index v.\d+' . $date_pattern_one_year . '/',
		
		// [ser.4]:v.15
		// [ser.4]:v.57 + Field Guide
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern  . '$/',
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern  . '\s+\+/',
		
		// [ser.4]:v.33:pt.2
		'/^' . $series_pattern . ':\s*' . $volume_prefix . $volume_number_pattern  . ':' . $issue_pattern . '$/',
		
		// [ser.4]:Suppl.1
		'/^' . $series_pattern . ':' . '(?<issue>Suppl\.\d+)' . '$/',
...
'v.24:pt.8:no.3 (1967)',
'v.32:no.13 (1970)',
'v.24:pt.11:no.4 (1976)',
'v.31:no.4 (1965)',
'v.31:no.14 (1968)',
'v.24:pt.10:no.1-2 (1974)',
'v.29:no.6 (1961)',
'v.31:no.5 (1965)',
'v.31:no.8 (1967)',
'v.30:no.2 (1959)',
'v.24:pt.9:no.3-4 (1973)',
'v.24:pt.7:no.1 (1961)',
'v.29:no.4 (1957)',
'v.32:no.4 (1968)',
'v.32:no.12 (1970)',
...
"ser.4:v.1=no.1-7 (1907-1912)",
"ser.4:v.2:pt.1=no.8-11 (1913-1917)",
"ser.4:v.2:pt.1=no.8-11 (1913-1917) [Lacks:Pl.13-14]",
"ser.4:v.2:pt.2=no.12-18 (1918-1926)",
"ser.4:v.2:pt.2=no.12-18 (1918-1926)",
"ser.4:v.3 (1908-1913)",
"ser.4:v.3 (1908-1913)",
"ser.4:v.4 (1914)",
"ser.4:v.4-5 (1914-1915)",
"ser.4:v.5 (1915)",
"ser.4:v.6 (1916)",
"ser.4:v.6 (1916)",
"ser.4:v.7 (1917)",
...
"ser.4:v.10 (1920)",
"ser.4:v.10 (1920)",
"ser.4:v.11 (1921-1922)",
"ser.4:v.11 (1921-1922)",
"ser.4:v.12 (1923-1924)",
"ser.4:v.12:no.1-28 (1923-1924)",
"ser.4:v.12:no.29-33 (1924) [Incomplete]",
"ser.4:v.13 (1923)",
"ser.4:v.14 (1924)",
"ser.4:v.15 (1926-1927)",
"ser.4:v.16 (1927-1928)",
"ser.4:v.17 (1928-1929)",
"ser.4:v.18 (1929-1930)",
"ser.4:v.19 (1930-1931)",
"ser.4:v.20 (1931-1933)",
"ser.4:v.21 (1933-1936)",
"ser.4:v.22 (1936-1941)",
"ser.4:v.23 (1935-1947)",
"ser.4:v.24 (1942-1950)",
"ser.4:v.25 (1943-1949)",
"ser.4:v.26 (1948-1950)",
"ser.4:v.27 (1951-1953)",
"ser.4:v.28 (1953-1956)",
"ser.4:v.29 (1956-1960)",
"ser.4:v.30 (1960-1968)",
"ser.4:v.31 (1960-1965)",
"ser.4:v.32 (1962-1968)",
"ser.4:v.33 (1965-1966)",
"ser.4:v.34 (1966-1967)",
"ser.4:v.35 (1967-1968)",
"ser.4:v.36 (1968-1969)",
"ser.4:v.37 (1969-1971)",
"ser.4:v.38 (1970)",
"ser.4:v.39 (1972-1974)",
"ser.4:v.40 (1974-1975)",
"ser.4:v.41 (1977-1979)",
"ser.4:v.42 (1979-1982)",
"ser.4:v.42 (1979-1982)",
"ser.4:v.43 (1982-1984)",
"ser.4:v.43 (1982-1984)",
"ser.4:v.44 (1985-1987)",
"ser.4:v.44 (1985-1987)",
"ser.4:v.45 (1987-1988)",
"ser.4:v.45 (1987-1988)",
"ser.4:v.46 (1988-1990)",
"ser.4:v.46 (1988-1990)",
"ser.4:v.47 (1990-1992)",
"ser.4:v.48 (1992-1995)",
"ser.4:v.49 (1995-1997)",
"ser.4:v.50 (1997-1998)",
"ser.4:v.51 (1999)",
"ser.4:v.52 (2000)",
"ser.4:v.53 (2002)",
"ser.4:v.54:no.1-8 (2003)",
"ser.4:v.54:no.9-21 (2003)",
"ser.4:v.54:no.22-27;Index v.54 (2003)",
"Table of Contents v.54 (2003)",
"Table of Contents v.54 (2003)",
"ser.4:v.55:no.1-12 (2004)",
"ser.4:v.55:no.13-25 (2004)",
"ser.4:v.55:no.26-35 (2004)",
"Table of Contents v.55 (2004)",
"ser.4:v.56:no.1-17 (2005)",
"ser.4:v.56:no.18-26 (2005)",
"ser.4:v.56:no.27-37;Index v.56 (2005)",
"Table of Contents v.56 (2005)",
"ser.4:v.57:no.1-11 (2006)",
"ser.4:v.57:no.12-24 (2006)",
"ser.4:v.57:no.25-38 (2006)",
"Table of Contents v.57 (2006)",
"Index v.55 (2004)",
"Index v.57 (2006)",
"v.62 (2015:Apr.)",
"v.62 (2015:Dec.)",
